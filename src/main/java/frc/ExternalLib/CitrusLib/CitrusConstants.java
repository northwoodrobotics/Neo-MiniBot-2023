...
public class CitrusConstants {
    ...
    public static final class AutoConstants {
		...
		new TrajectoryConfig(
				CitrusConstants.AutoConstants.kMaxSpeedMetersPerSecond,
				CitrusConstants.AutoConstants.kMaxAccelerationMetersPerSecondSquared)
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics);

		public static final TrajectoryConfig slowConfig = 
			new TrajectoryConfig(
				CitrusConstants.AutoConstants.kSlowMaxSpeedMetersPerSecond,
				CitrusConstants.AutoConstants.kSlowMaxAccelerationMetersPerSecondSquared)
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics);
		
		public static final TrajectoryConfig fastConfig = 
			new TrajectoryConfig(
				CitrusConstants.AutoConstants.kFastMaxSpeedMetersPerSecond,
				CitrusConstants.AutoConstants.kFastMaxAccelerationMetersPerSecondSquared)
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics);
		...
		public static final TrajectoryConfig RTNFastToZero = 
			new TrajectoryConfig(
				...
				CitrusConstants.AutoConstants.kFastMaxAccelerationMetersPerSecondSquared)
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics)
			.setStartVelocity(CitrusConstants.AutoConstants.kFastMaxSpeedMetersPerSecond)
			.setEndVelocity(0);
		...
		public static final TrajectoryConfig zeroToSlow =
			...
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics)
			.setStartVelocity(0)
			.setEndVelocity(CitrusConstants.AutoConstants.kSlowMaxSpeedMetersPerSecond);
		...
		public static final TrajectoryConfig intermediateSlow =
			new TrajectoryConfig(
				...
				CitrusConstants.AutoConstants.kSlowMaxAccelerationMetersPerSecondSquared)
			.setKinematics(CitrusConstants.SwerveConstants.swerveKinematics)
			.setStartVelocity(CitrusConstants.AutoConstants.kSlowMaxSpeedMetersPerSecond)
			.setEndVelocity(CitrusConstants.AutoConstants.kSlowMaxSpeedMetersPerSecond);
